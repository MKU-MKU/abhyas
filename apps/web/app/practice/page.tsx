...
export default function PracticePage() {
  ...
  if (!selectedChapter) return <main className="main"><section className="card"><h1>Question bank is being connected</h1><p>Content sources are not configured yet.</p></section></main>;
