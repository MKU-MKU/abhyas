...
import { getProgressStats } from "../../lib/learning/attempts";
...
export default function ReviewPage() {
  ...
  useEffect(() => {
    try { setWrong(JSON.parse(localStorage.getItem("abhyas:wrong") || "[]")); } catch { setWrong([]); }
  ...
  return <main className="main">
    ...
    <p className="subtitle">Incorrect Practice answers are retained locally for focused revision. Attempt statistics come from the shared learning contract.</p>
    <div className="stats">
      ...
      <div className="stat"><strong>{stats.accuracy}%</strong><span>Current accuracy</span></div>
    </div>
